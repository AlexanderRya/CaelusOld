...
namespace caelus::core::components::buffers {
    void VertexBuffer::allocate(const std::vector<types::Vertex>& vertices, const types::detail::VulkanData& data) {
        vk::Buffer temp_buffer{};
        vk::DeviceMemory temp_memory{};

        /* Allocate staging buffer */ {
            vk::BufferCreateInfo buffer_create_info{}; {
                buffer_create_info.size = vertices.size() * sizeof(types::Vertex);
            ...
            auto mapped = data.device_details.device.mapMemory(temp_memory, 0, vertices.size() * sizeof(types::Vertex));
        ...
        /* Copy to device local */ {
            ...
            vk::BufferCopy region{}; {
                region.size = vertices.size() * sizeof(types::Vertex);
                region.srcOffset = 0;
                region.dstOffset = 0;
            }
